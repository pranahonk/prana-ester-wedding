...
export default function GroomSlide() {
      ...
      <div className="relative z-10 text-center max-w-sm mx-auto">
        ...
        <SlideReveal delay={0.1} isActive={isActive}>
          <div className="relative mx-auto mb-8 sm:mb-10 w-36 h-36 sm:w-40 sm:h-40 md:w-44 md:h-44">
            ...
            >
              <Image
                src="/photos/DSC00240.jpg"
                alt="Prana Apsara Wijaya"
                fill
        ...
        <SlideReveal delay={0.4} isActive={isActive}>
          <a
            href="https://instagram.com/prana__wijaya"
            target="_blank"
          ...
          >
            <InstagramIcon />
            <span className="group-hover:underline underline-offset-4">@prana__wijaya</span>
          </a>
        </SlideReveal>
      </div>
    </SlideWrapper>
